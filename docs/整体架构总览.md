...
> 模块细节请翻 `docs/` 下对应的 `xxx模块.md`。实施计划是否已合入代码,以 [实施计划落地状态](实施计划落地状态.md) 为准。
...
| — | [实施计划落地状态.md](./实施计划落地状态.md) | 计划归档 | 各实施计划对照代码的完工状态 |
...
**文件**:`docs/上下文与记忆模块.md §7`、`docs/superpowers/specs/2026-08-29-ai-memory-design.md`
