...
<template>
  <Teleport to="body">
    <Transition name="app-modal">
      ...
      <label class="project-dialog__field">
        <span>项目描述</span>
        <textarea v-model="description" placeholder="可选，记录项目目标、背景或协作说明" maxlength="500" rows="3" />
      </label>
...
.project-dialog__head strong { display: block; font-size: 16px; line-height: 1.35; letter-spacing: -0.015em; }
...
.project-dialog__field textarea { resize: vertical; min-height: 72px; }
...
.project-dialog__foot { display: flex; justify-content: flex-end; gap: 9px; margin-top: 18px; }
