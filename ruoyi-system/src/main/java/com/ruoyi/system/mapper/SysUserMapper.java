...
public interface SysUserMapper
{
    ...
    /**
     * 按用户 ID 批量查询简要信息（知识库 owner/成员展示，禁止 N+1）
     *
    ...
    /**
     * 知识库成员候选搜索：启用且未删除用户，按用户名/昵称模糊，SQL 层排除 owner 与已有成员。
     * 须在 PageHelper.startPage 之后调用以分页。
     */
    public List<SysUser> selectKbMemberCandidates(@Param("keyword") String keyword,
